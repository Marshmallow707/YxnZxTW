...
This project is a **Tailwind CSS remake** of my original Bootstrap website, rebuilt 
with improved layout, styling, and interactivity. It was developed as a course project 
submission for **IT110 - JK01**.

The goal was to explore and apply **utility-first CSS techniques** using Tailwind while
...
- Tailwind CSS
- Vanilla JavaScript
- Custom CSS (animations, neon effects)
